  ...
  return (
    ...
    24 5.37 18.63 0 12 0z" />
        ...
        <div className=' h-px bg-linear-to-r from-neutral-700 via-white to-neutral-700'></div>
          ...
          <div className=' relative group'>
            <input type="submit" defaultValue="Sign-in" className='cursor-pointer w-full mt-2 border border-neutral-600 bg-neutral-700 py-1.5 rounded-sm font-medium' />
            <div className=" bottom-0 h-px bg-linear-to-r from-neutral-700  via-amber-500 to-neutral-700 w-full absolute opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
          </div>
        </form>
        <p className=' text-sm text-neutral-300 font-medium'>Don&apos;t have an account? <Link href="/sign-up" className=' underline italic text-neutral-200'>Sign-Up here</Link></p>
      </div>
    </div>
  )
}
